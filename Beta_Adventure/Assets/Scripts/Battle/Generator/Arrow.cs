    ...
    IEnumerator SpawnArrow(float Fx, float Fy, Direction dir)
    {
        switch (dir)
        {
            case Direction.x:
                ...
                GameObject attack_X = (GameObject)Instantiate(arrow_X, new Vector3(Fx-1f, Fy, 0f), Quaternion.identity);
            ...
            case Direction.y:
                ...
                GameObject attack_Y = (GameObject)Instantiate(arrow_Y, new Vector3(Fx, Fy+1f, 0f), Quaternion.identity);
